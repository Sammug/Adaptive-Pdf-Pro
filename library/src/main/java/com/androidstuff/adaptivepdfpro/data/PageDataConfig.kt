 ...
 */
@Parcelize
sealed class DataOverlay : Parcelable {
    @Parcelize
    data class Table(
    ...
    @Parcelize
    data class Custom(
        val viewData: String, // Changed from View to String as Views can't be parceled
...
data class PageData(
    ...
    val data: Map<String, String>, // Changed from Any to String for Parcelable support
